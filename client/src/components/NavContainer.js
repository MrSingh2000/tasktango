  ...
  return (
    <>
      <div className="flex flex-col w-full">
        {/* {!showSidebar ? ( */}
        <nav className="bg-white dark:bg-gray-800  shadow top-0 w-full z-20">
              ...
              <div className=" flex items-center">
                <div className="hidden md:block">
                  <div className="flex items-baseline ml-10 space-x-4">
                    <a
                      className="text-gray-800 hover:text-custom-yellow dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                      href="/#"
                    >
                      Dashboard
                    </a>
                ...
                <div className="hidden md:block">
                  <div className="flex items-baseline ml-10 space-x-4">
                    <a
                      className="text-gray-800 hover:text-[#FABB18] dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                      href="/#"
                    >
                      Create+
                    </a>
...
function SideNav() {
  ...
  return (
    <div className="bg-red-200 w-full lg:w-1/5 lg:block h-screen">
      <div className="w-fit m-auto p-10 text-2xl font-bold">
        TaskTang<span className="text-custom-yellow">o</span>
        </div>
