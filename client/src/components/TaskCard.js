...
//           <ul className="divide-y w-full divide-gray-200 overflow-y-auto max-h-[9rem] h-2/3 dark:divide-gray-700">
//             {task.subTask.map((sub, index) => {
//               return (
//                 <li key={index} className="relative py-3  h-1/5 dark:text-white sm:py-4 overflow-y-auto overflow-x-hidden max-w-3/4">
//                   <div className="absolute group scale-0 rounded  bg-gray-800 p-2 text-xs w-full text-white group-hover:scale-100 h-2/3">
//                     <div className="overflow-y-auto overflow-x-hidden w-full z-50 h-full">{sub.desc}</div>
//                   </div>
//                   <div className=" h-full flex items-start">
//                     <div className="group h-full flex items-start">
//                     <div className="absolute  scale-0 rounded  bg-gray-800 p-2 text-xs w-full text-white group-hover:scale-100 h-2/3">
//                       <div className="overflow-y-auto overflow-x-hidden w-full z-50 h-full">{sub.desc}</div>
//                     </div>
...
function TaskCard(props) {
  ...
  return addSubtask ? (
    ...
    <div className="w-full p-4 m-3 bg-white border border-gray-200 h-96 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 ">
      ...
      <div className="flex flex-col w-full">
        {task.subTask.length > 0 ? (
          <ul className="divide-y w-full divide-gray-200 max-h-[8rem] overflow-y-auto dark:divide-gray-700">
            {task.subTask.map((sub, index) => {
              return (
